    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.article_subcategories.index') }}"> @lang('site.list')</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.article_subcategories.store') }}" method="post"
                        ...
                        <input type="hidden" name="news_category_id" class="form-control" value="{{$catogery_id}}"
                               required>
                    @endforeach
                        @foreach (config('translatable.locales') as $locale)
