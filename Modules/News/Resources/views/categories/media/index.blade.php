        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <form action="{{ route('dashboard.media_subcategories.index') }}" method="get">
...
{{--                                <input type="hidden" name="cat_id" class="form-control" value="{{ (request()->segment(4))?request()->segment(4):$news_category_id }}">--}}
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_categories'))
                                    ...
                                    <a href="{{ route('dashboard.media_subcategories.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.add')</a>
                                 @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (auth()->user()->hasPermission('update_categories'))
                                            <a href="{{ route('dashboard.media_subcategories.edit', $value->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
                                        {{-- @else
                                            <a href="#" class="btn btn-info btn-sm disabled"><i class="fa fa-edit"></i> @lang('site.edit')</a> --}}
                                        @endif
                                        @if (auth()->user()->hasPermission('delete_categories'))
                                            <form action="{{ route('dashboard.media_subcategories.destroy', $value->id) }}" method="post" style="display: inline-block">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
