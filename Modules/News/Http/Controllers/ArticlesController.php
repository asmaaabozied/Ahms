...
class ArticlesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $catogery_ids=NewsCategory::where('type','articles')->get()->pluck('id');
        ...
        return view('news::categories.articles.index',compact('new_subcategory'));
    }
    ...
    public function create()
    {
        ...
        return view('news::categories.articles.create',compact('catogery_ids'));
    }
...
//           'image'=>'required',
        ...
        return redirect()->route('dashboard.article_subcategories.index');
    }
    ...
    public function edit($id)
    {
      $news_subcategory=NewsSubCategory::find($id);
        ...
        return view('news::categories.articles.edit',compact('news_subcategory','catogery_ids'));
    }
