...
class MediaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $catogery_ids=NewsCategory::where('type','video')->get()->pluck('id');
        ...
        return view('news::categories.media.index',compact('new_subcategory'));
    }
    ...
    public function create()
    {
        ...
        return view('news::categories.media.create',compact('catogery_ids'));
    }
...
//           'image'=>'required',
        ...
        if($request->hasFile('images')) {
            ...
            foreach ($imagess as $images) {
                ...
                $image = new \App\Image();
                $image->image = $img;
                $image->imageable_id = $newsubcatogery->id;
                $image->imageable_type ='Modules\News\Entities\NewsSubCategory';
                $image->save();
        ...
        return redirect()->route('dashboard.media_subcategories.index');
    }
    ...
    public function edit($id)
    {
      $news_subcategory=NewsSubCategory::find($id);
        ...
        return view('news::categories.media.edit',compact('news_subcategory','catogery_ids'));
    }
