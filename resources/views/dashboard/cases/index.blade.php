...
<td>
    ...
    <form action="{{ route('dashboard.cases.status', $case->id) }}" method="post" style="display: inline-block">
        {{ csrf_field() }}
        {{ method_field('POST') }}
        ...
        @endif
                                    ...
                                    <td><img src="{{asset('uploads/'.$case->icons)}}" style="width:100px; height:100px"></td>
