...
{{--                        <span>@lang('site.consultations')</span>--}}
{{--                        <span class="pull-right-container">--}}
{{--                        <i class="fa fa-angle-left pull-right"></i>--}}
{{--                    </span>--}}
{{--                    </a>--}}
...
{{--                        <li><a href="{{ route('dashboard.typeconsultations.index') }}"><i class="fa fa-building-o"></i><span>@lang('site.typeconslutions')</span></a></li>--}}
{{--                        <li><a href="{{ route('dashboard.videoconsultations.index') }}"><i class="fa fa-building-o"></i><span>@lang('site.videoconslutions')</span></a></li>--}}
...
{{--                            <li><a href="{{ route('dashboard.inquiress.index') }}"><i class=" fa fa-medkit fa fa-1.5x"></i><span>@lang('site.inquires')--}}
...
{{--            @endif--}}
            @if (auth()->user()->hasPermission('read_contactusmassages'))
                <li class="treeview">
                    ...
                    <ul class="treeview-menu" style="display:none">
                        <li><a href="{{ route('dashboard.catogeryjobs.index') }}"><i class=" fa fa-th fa fa-1.5x"></i><span>Complain</span></a></li>
                        <li><a href="{{ route('dashboard.contacts.index') }}"><i class="fa fa-envelope"></i><span>@lang('site.contact')
                            ...
                            @php  $cout=\App\Contact::where('read_at',0)->count()
...
{{--            @if (auth()->user()->hasPermission('read_sponsers'))--}}

{{--                <li><a href="{{ route('dashboard.sponsers.index') }}"><i class="fas fa-user-circle"></i><span>@lang('site.sponsers')--}}
...
{{--                    </a>--}}
{{--                    <ul class="treeview-menu" style="display:none">--}}
{{--                        <li><a href="{{ route('dashboard.reportcases') }}"><i class="fa fa-building-o"></i><span>@lang('site.cases')</span></a></li>--}}
{{--                        <li><a href="{{ route('dashboard.reportconsulation') }}"><i class="fa fa-building-o"></i><span>@lang('site.consultations')</span></a></li>--}}
{{--                        <li><a href="{{ route('dashboard.reportusers') }}"><i class="fa fa-building-o"></i><span>@lang('site.users')</span></a></li>--}}
{{--                        <li><a href="{{ route('dashboard.reportvisitor') }}"><i class="fa fa-building-o"></i><span>@lang('site.reportvisitor')</span></a></li>--}}
